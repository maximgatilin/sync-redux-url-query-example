  ...
  render() {
    return (
      <div style={{fontSize: 20, lineHeight: 1.8}}>
        Hi, stranger!
        <br/>
        I've created this tiny app to show you how a Redux store can be connected with URL queries.
        <br/>
        ...
        <br/>
        <br/>
        Source code is available on <a href="https://github.com/maximgatilin/sync-redux-url-query-example" target="_blank">Github</a>
      </div>
    );
  }
}
